...
#number of parameters is all the coeffecients, in this case, intercept, group, and 2 additional works (3 work categories). So 1 + 1 + 2 = 4
AIC.e <- 2*4 - 2 *logLik(q3.cox.e)
AIC.e

#added age as a parameter, so 4 + 1 = 5
AIC.a.e <- 2*5 - 2 * logLik(q3.cox.a.e)
AIC.a.e
